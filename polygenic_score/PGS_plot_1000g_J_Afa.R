...
#no gomi
GP_nogomi_j<-read_csv("~/testdir/savage/plink_intelligence/results/PGS_1000G_J_Afa_9k.csv")
...
b<- ggplot(GP3, aes(x = GP3$effect_sum),) +
  ...
  scale_color_manual(name = "Polygenic score, 9128 SNPs", values = c("Funadomari Jomon" = "#33FFFF",
...
ggsave("1000GP_jomon_afa_9128_2.png",b, width = 30, height = 15, units = "cm",dpi = "retina")

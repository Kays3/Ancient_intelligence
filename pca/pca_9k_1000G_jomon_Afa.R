...
#add Jomon
#9K snsps work  - NO GOMI Afanasievo included
...
# read in data
pca <- read_table2("./merged_update_1000G_J_Afa.eigenvec", col_names = FALSE)
eigenval <- scan("./merged_update_1000G_J_Afa.eigenval")
...
b <- ggplot(pca, aes(PC1, PC2, col = spp, shape = spp )) +
  ...
  geom_point(data=pca[1661, ], size=6,alpha = 9/10,) +
...
ggsave("pca_9k_1000G_jomon_Afanasievo.png", aca, width=7, height=5, units="in", dpi=500)
